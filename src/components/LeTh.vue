    ...
    <div class="total_theme">
      <div class="theme">
        ...
        <div class="box box-used p_bottom">
          ...
          <el-dialog v-model="dialogVisible" title="风险源定量识别与表征模型" width="500" :close-on-click-modal="false"
            class="dialog_trigrs">
      ...
      <div class="theme">
        ...
        <div class="box box-used p_bottom">
          ...
          <el-dialog v-model="dialogVisible1" title="山洪泥石流启动动力学模型" width="500" :close-on-click-modal="false"
      ...
      <div class="theme">
        ...
        <div class="box p_bottom box-used">
          ...
          <el-dialog v-model="dialog_inverseV" title="滑坡预警（测试版）" width="500" :close-on-click-modal="false"
            ...
            <el-form :model="form" label-width="auto" style="max-width: 600px" class="form_inverseV">
