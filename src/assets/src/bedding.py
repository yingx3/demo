...
if __name__ == '__main__':
    params = {
        "melt_duration": 240,  # 融冰时长（小时）
        "slope_angle": 60,  # 边坡坡度
        "slide_angle": 15,  # 滑面角
        "ice_thickness": 4,  # 冰层厚度
        "fissure_height": 10,  # 裂隙高度
        "slide_length": 20,  # 滑面长度
        "cohesion": 15,  # 有效粘聚力
        "friction_angle": 20,  # 有效内摩擦角
        "rock_density": 20,  # 岩体重度
        "permeability": 0.0001  # 渗透系数
    }
